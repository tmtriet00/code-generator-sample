package com.ntap.corebe.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.ntap.corebe.IntegrationTest;
import com.ntap.corebe.repository.timezone.DateTimeWrapper;
import com.ntap.corebe.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ntap_date_time_wrapper where id=%d", fieldName, id);
    }
